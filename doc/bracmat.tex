...
let\d checks whether a single character is a letter. This function uses the Unicode definitions of letters as found in Unicode.txt. On success, the single character is returned. The function fails if the argument is not a single character that is a letter.
